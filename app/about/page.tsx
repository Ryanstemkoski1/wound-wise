    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-linear-to-b from-primary/5 via-background to-background border-b">
        ...
        <div className="container relative mx-auto px-4 py-16 md:py-24">
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8 animate-in fade-in">
          ...
          <Card className="bg-primary/5 border-primary/20">
            ...
            <CardContent>
              <p className="text-lg leading-relaxed">
                ...
                participation in their healing journey. Every patient deserves
                to understand their condition and feel confident in their care.
              </p>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="mb-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-4 text-muted-foreground">
            <p className="leading-relaxed">
              ...
              and manage the complex wounds that result from surgical
              procedures. It was during this training that he learned from wound
              and ostomy nurses about approaching, fostering, and caring for
              chronic wounds—and the patients who have them.
            </p>
            <p className="leading-relaxed">
            ...
            <p className="leading-relaxed">
              ...
              countless times to patients, always working to make complex
              medical information understandable and actionable.
            </p>
          </div>
        </section>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  All content is written by Dr. May, ensuring medical accuracy
                  and clinical relevance based on decades of hands-on experience
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  Complex concepts are explained using clear language,
                  analogies, and real-world examples that resonate.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  current best practices, giving you confidence in the
            ...
            <CardContent className="pt-6">
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  approach—one that addresses not just the visible wound, but
                  the whole person. Successful healing involves managing
                  underlying medical conditions, optimizing nutrition, ensuring
                  proper blood flow, controlling infection, and supporting the
                ...
                <p>
                  ...
                  collaboratively with their healthcare team for optimal
                  outcomes.
                </p>
                <p>
