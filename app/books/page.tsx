            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>
                      How wounds heal and what can go wrong in the healing
                      process
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="border-t pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  jargon. Written in accessible language with real-world
                  examples and practical analogies.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>
                      Space to document wound appearance, size, drainage, and
                      pain levels
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Whether you&apos;re newly diagnosed with a chronic wound or
                  have been struggling for months, these resources offer
                  clarity, hope, and practical strategies for your healing
                  journey.
                </p>
              </div>
            </CardContent>
