          ...
          <div className="grid gap-4">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Questions about Dr. May&apos;s published books, &quot;Heal
                  Your Wound&quot; and the &quot;Wound Healing Journal,&quot;
                  including purchasing and availability.
                </p>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardContent className="pt-6 space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  No. WoundWise provides general educational information only.
                  We cannot provide personalized medical advice, diagnose
                  conditions, or recommend specific treatments for your
                  situation. Please consult your healthcare provider.
                </p>
              </div>
              ...
              <div className="pt-4 border-t">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  WoundWise participates in the Amazon Associates Program. We
                  may earn a small commission when you purchase products through
                  our affiliate links, at no cost to you. Our recommendations
                  are based on clinical knowledge and wound care expertise. See
                  our{" "}
                  <Link
              ...
              <div className="pt-4 border-t">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Content on WoundWise is protected by copyright. You may read
                  and reference it for personal use, but reproduction or
                  commercial use requires permission. Please review our{" "}
                  <Link
                    href="/legal/terms"
                    className="text-primary hover:underline"
                  >
