      ...
      <div className="prose prose-lg max-w-none space-y-6">
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            better understand chronic wounds and their treatment. The content is
            based on Dr. Alvin May&apos;s clinical experience and published
            works, including &quot;Heal Your Wound&quot; and the &quot;Wound
            Healing Journal.&quot;
          </p>
          <p className="text-muted-foreground leading-relaxed">
            This website aims to empower patients with knowledge, but it cannot
            replace individualized medical care from qualified healthcare
            professionals who can examine you, order appropriate tests, and
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Every patient is unique, and wound care must be individualized based
            on your specific medical history, current health conditions,
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed mt-4">
            ...
            this website. If you think you have a medical emergency, call 911 or
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            between you and Dr. Alvin May or any other healthcare provider. The
            information provided is general in nature and cannot address your
            specific medical situation. For personalized medical advice, you
            must establish a formal relationship with a healthcare provider who
            can examine you and review your medical history.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            While we strive to provide accurate, up-to-date information based on
            current medical knowledge and Dr. May&apos;s clinical experience,
            medical science evolves constantly. Information that was accurate
            when published may become outdated as new research emerges. We
            cannot guarantee that all information on this website is complete,
            accurate, or current.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            ...
            their guidance, which will be based on the most current evidence and
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            This website may recommend specific wound care products and include
            affiliate links (primarily through Amazon Associates). These
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            WoundWise, Dr. Alvin May, and all associated parties are not liable
            for any damages arising from your use of this website or reliance on
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            accept this disclaimer and agree to hold WoundWise and Dr. Alvin May
            harmless from any claims arising from your use of the information
            provided.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            If you have questions about your wound or medical condition, please
            contact your healthcare provider directly. For questions about this
            website or its content, please use our contact form.
          </p>
        </section>
