    ...
    <div className="container py-10 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none space-y-6">
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            This information is collected through standard web technologies such
            as cookies and web server logs. It helps us understand how visitors
            use our website and improve the user experience.
          </p>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            WoundWise uses cookies and similar tracking technologies to enhance
            your browsing experience. Cookies are small text files stored on
            your device that help us recognize your browser and remember your
            preferences.
          </p>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            When you click on Amazon affiliate links and make a purchase, we may
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            to help us understand how visitors use our website. These services
            may collect information about your use of this and other websites,
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            WoundWise is not directed to children under the age of 13. We do not
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            we collect. However, no method of transmission over the Internet or
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            not collect sensitive personal or medical information, the security
            risk is minimal.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            <li>
              <strong>Access and Update:</strong> You can request access to any
            ...
            <li>
              ...
              Track&quot; features. Currently, there is no industry standard for
              responding to such signals, and we do not respond to them at this
              time.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            regulatory reasons. We will post the updated policy on this page and
