          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                By accessing and using WoundWise, you agree to be bound by these
      ...
      <div className="prose prose-lg max-w-none space-y-6">
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            use of the WoundWise website (the &quot;Website&quot;), operated by
            Dr. Alvin May (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            purposes. You may read, download, and print content from the Website
            for your own reference, subject to the restrictions below.
          </p>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            software, is the property of WoundWise or its content suppliers and
          ...
          <p className="text-muted-foreground leading-relaxed">
            Much of the educational content on this Website is derived from Dr.
            Alvin May&apos;s published books, including &quot;Heal Your
            Wound&quot; and the &quot;Wound Healing Journal.&quot; These works
            are protected by copyright. The Website makes portions of this
            content available for free as an educational service, but this does
            not grant you rights to reproduce or distribute the full works.
          </p>

          <h3 className="text-xl font-semibold mb-3 mt-6">Limited License</h3>
          <p className="text-muted-foreground leading-relaxed">
            We grant you a limited, non-exclusive, non-transferable license to
            access and use the Website for personal, educational purposes. This
            license does not include any right to:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            <li>Resell or make commercial use of the Website or its content</li>
            <li>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Product recommendations are based on our knowledge and experience in
            wound care. However:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li>
              We do not warrant that products will be suitable for your specific
              needs
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            endorse and are not responsible for:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            <li>
              The content, accuracy, or opinions expressed on external websites
            </li>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            OR THAT USE OF THE WEBSITE WILL BE UNINTERRUPTED OR ERROR-FREE.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li>
              Health outcomes or medical decisions based on information from the
              Website
            </li>
            <li>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            (or any part thereof) at any time without notice. We may also modify
            these Terms at any time by posting updated Terms on the Website.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            the laws of the United States and the State of [Your State], without
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            [Your County and State]. You agree to submit to the jurisdiction of
            such courts.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            and effect. The invalid or unenforceable provision shall be deemed
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            WoundWise regarding your use of the Website and supersede all prior
