  ...
  return (
    <div className="container py-10">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
        ...
        <ChevronRight className="h-4 w-4" />
        <span className="text-foreground font-medium">Interactive Tracker</span>
      </nav>

      {/* Hero Section */}
      <section className="relative overflow-hidden bg-linear-to-b from-primary/5 via-background to-background rounded-lg mb-8">
      ...
      <Alert className="mb-8 bg-accent/10 border-accent/30">
        <AlertDescription className="text-sm">
          ...
          locally in your browser. Data is never sent to our servers. Make sure
          to export your data regularly to avoid losing it if you clear your
          browser cache.
        </AlertDescription>
      </Alert>
